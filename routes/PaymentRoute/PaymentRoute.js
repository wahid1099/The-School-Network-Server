...
router.post("/addmissionpayment", async (req, res) => {
  ...
  router.post("/successes", async (req, res) => {
    ...
    res
      .status(200)
      .redirect(`https://the-school-network.web.app//AdmissionSuccess`);
  });
...
router.post("/PayMonthlyPayment", async (req, res) => {
  ...
  router.post("/success", async (req, res) => {
    ...
    const notice = await MonthlyPayment.findOneAndUpdate(
      query,
      {
        $set: {
          paymentStatus: "PAID",
          tran_id: uuidv4(),
          paymentNumber: datas.paymentNumber,
    ...
    res
      .status(200)
      .redirect(
        `https://the-school-network.web.app//StudentDashboard/StudentPaymentSuccess`
      );
  });
